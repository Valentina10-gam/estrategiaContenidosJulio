const contentPieces = [
  ...
  },
  {
    ...
    format: "Post nativo",
    network: "LinkedIn",
    pillar: "Autoridad técnica",
    sector: "B2B multisede",
    title: "La frecuencia no debería copiarse entre sedes.",
    objective: "Hablarle a Operaciones y Calidad.",
    hook: "Dos sedes de una misma empresa pueden necesitar estrategias diferentes.",
    cta: "¿Tus sedes se revisan por condiciones reales o bajo el mismo esquema?",
    stories: ["No aplica."],
    material: "Placa simple.",
    status: "Listo para diseño.",
